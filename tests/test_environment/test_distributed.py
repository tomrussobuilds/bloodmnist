...
# GET_RANK
@pytest.mark.unit
def test_get_rank_defaults_to_zero(monkeypatch):
...
@pytest.mark.unit
def test_get_rank_reads_env_var(monkeypatch):
...
@pytest.mark.unit
def test_get_rank_returns_zero_for_rank_zero(monkeypatch):
...
# GET_LOCAL_RANK
@pytest.mark.unit
def test_get_local_rank_defaults_to_zero(monkeypatch):
...
@pytest.mark.unit
def test_get_local_rank_reads_env_var(monkeypatch):
...
# GET_WORLD_SIZE
@pytest.mark.unit
def test_get_world_size_defaults_to_one(monkeypatch):
...
@pytest.mark.unit
def test_get_world_size_reads_env_var(monkeypatch):
...
@pytest.mark.unit
def test_is_distributed_true_with_rank(monkeypatch):
...
@pytest.mark.unit
def test_is_distributed_true_with_local_rank(monkeypatch):
...
@pytest.mark.unit
def test_is_distributed_true_with_both(monkeypatch):
...
# IS_MAIN_PROCESS
@pytest.mark.unit
def test_is_main_process_true_by_default(monkeypatch):
...
@pytest.mark.unit
def test_is_main_process_false_for_non_zero_rank(monkeypatch):
...
@pytest.mark.unit
def test_is_main_process_false_for_high_rank(monkeypatch):
